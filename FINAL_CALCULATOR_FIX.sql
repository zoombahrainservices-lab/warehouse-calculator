-- FINAL CALCULATOR FIX - Complete Restoration
-- This will fix your calculator completely
...
-- 2. Add ALL missing pricing rates
...
(gen_random_uuid(), 'House load electricity included in rent - up to 5kW', 'Dedicated meter with separate billing - setup required', 50.00, 25.00)
ON CONFLICT DO NOTHING;
