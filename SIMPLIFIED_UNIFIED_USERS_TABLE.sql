-- SIMPLIFIED UNIFIED USERS TABLE
-- This consolidates users and warehouse occupants into one simple table
-- Much less complex and easier to manage!
...
-- 2. Create a new unified table structure
CREATE TABLE IF NOT EXISTS unified_users (
    ...
    -- Warehouse-specific fields (only for users with warehouse space)
