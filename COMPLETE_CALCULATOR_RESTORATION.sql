-- COMPLETE CALCULATOR RESTORATION
-- This will restore your calculator with complete pricing matrix

-- 1. First, let's see what we have and clean up
SELECT '=== STARTING COMPLETE RESTORATION ===' as info;
...
-- 5. Add comprehensive optional services
...
SELECT '=== COMPREHENSIVE VERIFICATION ===' as info;

-- Test ALL problematic scenarios
